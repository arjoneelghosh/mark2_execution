  ...
  return (
    <div className="bg-page min-h-screen relative">
      ...
      <div className="relative z-10 max-w-[1520px] mx-auto pl-9 pr-8 py-8 lg:pl-14 lg:pr-14 lg:py-10">
        <div className="surface-shell-deep ask-shell animate-fade-in overflow-hidden rounded-[30px] xl:h-[calc(100dvh-5.5rem)] xl:min-h-[680px] xl:max-h-[860px]">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[340px_minmax(0,1fr)] xl:h-[calc(100%-10.25rem)] min-h-0">
            ...
            <section className="surface-chat-column min-h-0 min-w-0 overflow-hidden">
              <PortfolioChatPanel
                ...
                embedded={true}
                integrated={true}
                className="ask-chat-panel h-full min-h-0"
              />
            </section>
          </div>
        </div>
